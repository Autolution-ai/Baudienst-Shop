...
const PRODUCTS = {
  ...
  'pg400': {
    ...
    desc: 'Universeller Einscheiben-Bodenschleifer für Vorbereitung, Renovierung und Endbearbeitung mittlerer Flächen.',
    priceNet: 5494.67,
    priceGross: 6538.66,
    qty: 'Einzelgerät',
  ...
  'ez-h': {
    ...
    desc: 'Für harte Betonuntergründe. Werkzeugaufnahme EZchange.',
  ...
  'ez-s': {
    ...
    desc: 'Für abrasive Untergründe und weichen Beton. EZchange-Aufnahme.',
  ...
  'ez-x': {
    ...
    desc: 'Für sehr harte Betonuntergründe und Granit.',
    priceNet: 76.36, priceGross: 90.87, qty: '3er-Set',
  ...
  'ez-sharxx': {
    ...
    desc: 'Extrem aggressives Segment für sehr harte Untergründe.',
    priceNet: 76.36, priceGross: 90.87, qty: '3er-Set',
  ...
  'ez-m': {
    ...
    desc: 'Allrounder für mittelharten Beton — Standard für die meisten Projekte.',
    priceNet: 76.36, priceGross: 90.87, qty: '3er-Set',
  ...
  't-rex-dome': {
    ...
    desc: 'Aggressiver PCD-Block für alle Untergründe und Epoxidböden.',
  ...
  't-rex-super': {
    ...
    desc: '5-Block-PCD für maximale Abtragsleistung auf allen Untergründen.',
  ...
  'vari-grind-sl': {
    ...
    desc: 'Spezialsegment für Holzschleifen und Feinbearbeitung.',
  ...
  'adapter-multi-400-9': {
    ...
    desc: 'Adapterplatte für PG 400 mit 9 Werkzeugpositionen.',
  ...
  'adapter-multi-280-6': {
    ...
    desc: 'Adapterplatte für PG 280 mit 6 Werkzeugpositionen.',
  ...
  'halter-multi-400-9': {
    ...
    desc: 'Werkzeughalter für PG 400 mit 9 Aufnahmen.',
  ...
  'halter-multi-230-6': {
    ...
    desc: 'Werkzeughalter für PG 540 mit 6 Aufnahmen, harte Ausführung.',
